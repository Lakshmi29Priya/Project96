...
addRequest=async(bookName,reasonToRequest)=>{
  ...
  var books=await BookSearch.searchbook(bookName,'AIzaSyC65FCDk5pk9mP-DJ8PHyrXKnBliyMCndc')
    ...
    return(
      ...
      :(
        ...
        <TextInput
          ...
          multiline
          numberOfLines ={8}
          placeholder={"Why do you need the gift"}
          onChangeText ={(text)=>{
              this.setState({
